...
void main()
{
    ...
    for(int i = 0; i < 4; i++)
    {
        ...
        if (index == uHoveredBone || index == uSelectedBone)
        {
            hoverWeight += weight;
        }
    ...
    vec4 worldPos = uModel * vec4(totalLocalPos.xyz, 1.0);
    gl_Position = uProjection * uView * worldPos;

    vHoverWeight = hoverWeight;
}
